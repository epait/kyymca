...
abstract class Ai1wm_Archiver {
	...
	protected function open_file_in_mode( $file, $mode ) {
		...
		if ( false === $file_handle ) {
			...
			throw new Ai1wm_Not_Accesible_Exception( __( 'Unable to open ' . $file, AI1WM_PLUGIN_NAME ) );
		}
	...
	protected function write_to_handle( $handle, $data, $file ) {
		...
		if ( false === $result ) {
			throw new Ai1wm_Not_Writable_Exception( __( 'Unable to write to ' . $file, AI1WM_PLUGIN_NAME ) );
		}
	}
