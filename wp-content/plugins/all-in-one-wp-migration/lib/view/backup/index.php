				...
				<?php if ( is_readable( AI1WM_BACKUPS_PATH ) && is_writable( AI1WM_BACKUPS_PATH ) ): ?>
					<div class="ai1wm-clear">
						<p id="ai1wm-backup-size">
							<?php _e( 'Disk space', AI1WM_PLUGIN_NAME ); ?>
							<strong><?php echo size_format( $used_space, 2 ); ?></strong>
							<?php _e( 'of', AI1WM_PLUGIN_NAME ); ?>
							<strong><?php echo size_format( $total_space, 2 ); ?></strong>
						</p>

						<?php $progress = ceil( ( $used_space / $total_space ) * 100 ); ?>
					...
					<div class="ai1wm-backups-empty <?php echo empty( $backups ) ? null : 'ai1wm-hide'; ?>">
						<p><?php _e( 'There are not backups available at this time, why not create a new one?', AI1WM_PLUGIN_NAME ); ?></p>
						<p>
