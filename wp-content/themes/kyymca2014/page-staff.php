	            		...
	            		<div class="col-sm-4">
	            			<div class="sidebar">
	            				...
	            				<?php
									...
									if( have_rows('administrative_staff', 'option') ): ?>
										<?php 
									 	// loop through the rows of data
									    while ( have_rows('administrative_staff', 'option') ) : the_row();
								...
								<?php
									// check if the repeater field has rows of data
									if( have_rows('program_staff', 'option') ): ?>
									<h4>Program Staff</h4>
										<?php 
									 	// loop through the rows of data
									    while ( have_rows('program_staff', 'option') ) : the_row();
									        // display a sub field value ?> 
									        <div class="national-officer">
									        	<a class="officer-name" href='<?php the_sub_field('page_link'); ?>'><?php the_sub_field('name'); ?></a><br />
									        	<span class="officer-position"><?php the_sub_field('position'); ?></span><br />
								...
								<?php
									// check if the repeater field has rows of data
									if( have_rows('community_engagement_staff', 'option') ): ?>
										<h4>Community Engagement Staff</h4>
										<?php 
									 	// loop through the rows of data
									    while ( have_rows('community_engagement_staff', 'option') ) : the_row();
									        // display a sub field value ?> 
									        <div class="national-officer">
									        	<a class="officer-name" href='<?php the_sub_field('page_link'); ?>'><?php the_sub_field('name'); ?></a><br />
									        	<span class="officer-position"><?php the_sub_field('position'); ?></span><br />
