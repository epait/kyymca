<?php
/*
Template Name: MS KYA 2 Officer
*/
?>
<!-- Main Content -->
<?php get_header() ?>
	            	...
	            	<div class="row-fluid">
	            		<div class="col-sm-4">
	            			<div class="sidebar">
	            				...
	            				<?php
	            					wp_nav_menu( array( 'theme_location' => 'kya-ms-2-menu', 'menu_class' => 'sidebar-menu' ) );
									// check if the repeater field has rows of data
									if( have_rows('ms_kya_2_officers', 'option') ): ?>
										<br />
										<h4 class="sidebar-title">Presiding Officers</h4>
										<?php 
									 	// loop through the rows of data
									    while ( have_rows('ms_kya_2_officers', 'option') ) : the_row();
