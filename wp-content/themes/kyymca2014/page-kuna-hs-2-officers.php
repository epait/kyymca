<?php
/*
Template Name: HS KUNA 2 Officer
*/
?>
<!-- Main Content -->
<?php get_header() ?>
	            		...
	            		<div class="col-sm-4">
	            			<div class="sidebar">
	            				...
	            				<?php
									...
									if( have_rows('hs_kuna_2_officers', 'option') ): ?>
										<br />
										<h4 class="sidebar-title">Presiding Officers</h4>
										<?php 
										wp_nav_menu( array( 'theme_location' => 'kuna-hs-2-menu', 'menu_class' => 'sidebar-menu' ) );
									 	// loop through the rows of data
									    while ( have_rows('hs_kuna_2_officers', 'option') ) : the_row();
